...
export default class EquipmentApi {
    ...
    */
     ...
     */
    getItemsEquipmentList(language, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getItemsEquipmentSearch(language, query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
      ...
      return this.apiClient.callApi(
        '/{language}/items/equipment/search', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    getItemsEquipmentSingle(language, ankamaId, callback) {
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
      ...
      return this.apiClient.callApi(
        '/{language}/items/equipment/{ankama_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
