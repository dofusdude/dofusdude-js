...
export default class ResourcesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllItemsResourcesList operation.
     * @callback module:api/ResourcesApi~getAllItemsResourcesListCallback
     ...
     * @param {module:api/ResourcesApi~getAllItemsResourcesListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListItems}
     */
    getAllItemsResourcesList(language, game, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
        throw new Error("Missing the required parameter 'language' when calling getAllItemsResourcesList");
      }
      // verify the required parameter 'game' is set
      if (game === undefined || game === null) {
        throw new Error("Missing the required parameter 'game' when calling getAllItemsResourcesList");
      }
      ...
      return this.apiClient.callApi(
        '/{game}/v1/{language}/items/resources/all', 'GET',
    ...
    /**
     * Callback function to receive the result of the getItemsResourceSearch operation.
     * @callback module:api/ResourcesApi~getItemsResourceSearchCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Array.<String>} [filterTypeNameId] multi-filter results with the english type name. Add with \"wood\" or \"+wood\" and exclude with \"-wood\".
     * @param {module:api/ResourcesApi~getItemsResourceSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ListItem>}
     */
    getItemsResourceSearch(language, game, query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
        throw new Error("Missing the required parameter 'language' when calling getItemsResourceSearch");
      }
      // verify the required parameter 'game' is set
      if (game === undefined || game === null) {
        throw new Error("Missing the required parameter 'game' when calling getItemsResourceSearch");
      }
      // verify the required parameter 'query' is set
      if (query === undefined || query === null) {
        throw new Error("Missing the required parameter 'query' when calling getItemsResourceSearch");
      }
      ...
      return this.apiClient.callApi(
        '/{game}/v1/{language}/items/resources/search', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getItemsResourcesList operation.
     * @callback module:api/ResourcesApi~getItemsResourcesListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListItems} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Array.<String>} [filterTypeNameId] multi-filter results with the english type name. Add with \"wood\" or \"+wood\" and exclude with \"-wood\".
     * @param {module:api/ResourcesApi~getItemsResourcesListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListItems}
     */
    getItemsResourcesList(language, game, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
        throw new Error("Missing the required parameter 'language' when calling getItemsResourcesList");
      }
      // verify the required parameter 'game' is set
      if (game === undefined || game === null) {
        throw new Error("Missing the required parameter 'game' when calling getItemsResourcesList");
      }
      ...
      let returnType = ListItems;
      return this.apiClient.callApi(
        '/{game}/v1/{language}/items/resources', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getItemsResourcesSingle operation.
     * @callback module:api/ResourcesApi~getItemsResourcesSingleCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/String} game game main 'dofus3' or beta channel 'dofus3beta'
     * @param {module:api/ResourcesApi~getItemsResourcesSingleCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Resource}
     */
    getItemsResourcesSingle(language, ankamaId, game, callback) {
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
        throw new Error("Missing the required parameter 'language' when calling getItemsResourcesSingle");
      }
      // verify the required parameter 'ankamaId' is set
      if (ankamaId === undefined || ankamaId === null) {
        throw new Error("Missing the required parameter 'ankamaId' when calling getItemsResourcesSingle");
      }
      // verify the required parameter 'game' is set
      if (game === undefined || game === null) {
        throw new Error("Missing the required parameter 'game' when calling getItemsResourcesSingle");
      }
      ...
      return this.apiClient.callApi(
        '/{game}/v1/{language}/items/resources/{ankama_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
