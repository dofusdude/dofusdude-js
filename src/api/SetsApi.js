...
export default class SetsApi {
    ...
    */
     ...
     */
    getSetsList(language, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getSetsSearch(language, query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
     ...
     */
    getSetsSingle(language, ankamaId, callback) {
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
