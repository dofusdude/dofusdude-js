...
export default class CosmeticsApi {
    ...
    */
     ...
     */
    getCosmeticsList(language, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getCosmeticsSearch(language, query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
      ...
      return this.apiClient.callApi(
        '/{language}/items/cosmetics/search', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    getCosmeticsSingle(language, ankamaId, callback) {
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
      ...
      return this.apiClient.callApi(
        '/{language}/items/cosmetics/{ankama_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
