...
export default class ConsumablesApi {
    ...
    */
     ...
     */
    getItemsConsumablesList(language, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/{language}/items/consumables', 'GET',
     ...
     */
    getItemsConsumablesSearch(language, query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
      ...
      return this.apiClient.callApi(
        '/{language}/items/consumables/search', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    getItemsConsumablesSingle(language, ankamaId, callback) {
      let postBody = null;
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
      ...
      return this.apiClient.callApi(
        '/{language}/items/consumables/{ankama_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
