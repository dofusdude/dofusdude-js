...
export default class GameApi {
    ...
    */
     ...
     * @param {Array.<module:model/String>} [fieldsItem] adds fields from the item search to the list entries if the hit is an item. Multiple comma separated values allowed.
     * @param {Array.<String>} [filterTypeNameId] multi-filter results with the english item type name, including \"mount\" and \"set\" from filter[search_index]. Add with \"wood\" or \"+wood\" and exclude with \"-wood\".
