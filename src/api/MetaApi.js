...
export default class MetaApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/GetMetaVersion200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/GetMetaVersion200Response}
     */
    getMetaVersion(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetMetaVersion200Response;
      return this.apiClient.callApi(
        '/dofus2/meta/version', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
