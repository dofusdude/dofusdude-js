...
export default class MetaApi {
    ...
    */
     ...
     */
    getGameSearchTypes(game, callback) {
      let postBody = null;
      // verify the required parameter 'game' is set
      if (game === undefined || game === null) {
        throw new Error("Missing the required parameter 'game' when calling getGameSearchTypes");
      }
     ...
     * data is of type: {@link Array.<String>}
     */
    getItemTypes(game, callback) {
      let postBody = null;
      // verify the required parameter 'game' is set
      if (game === undefined || game === null) {
        throw new Error("Missing the required parameter 'game' when calling getItemTypes");
      }
    ...
    getMetaAlmanaxBonuses(language, callback) {
      ...
      return this.apiClient.callApi(
        '/dofus3/v1/meta/{language}/almanax/bonuses', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    getMetaAlmanaxBonusesSearch(language, query, opts, callback) {
      ...
      let returnType = [GetMetaAlmanaxBonuses200ResponseInner];
      return this.apiClient.callApi(
        '/dofus3/v1/meta/{language}/almanax/bonuses/search', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link Array.<String>}
     */
    getMetaElements(game, callback) {
      let postBody = null;
      // verify the required parameter 'game' is set
      if (game === undefined || game === null) {
        throw new Error("Missing the required parameter 'game' when calling getMetaElements");
      }
