...
/**
 * The PagedLinks model module.
 * @module model/PagedLinks
 * @version 1.0.0-rc.4
 */
class PagedLinks {
    /**
     * Constructs a new <code>PagedLinks</code>.
     * @alias module:model/PagedLinks
     */
    constructor() { 
        
        PagedLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PagedLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PagedLinks} obj Optional instance to populate.
     * @return {module:model/PagedLinks} The populated <code>PagedLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PagedLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>PagedLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PagedLinks</code>.
     */
 ...
 * @member {String} first
 */
PagedLinks.prototype['first'] = undefined;

/**
 * @member {String} prev
 */
PagedLinks.prototype['prev'] = undefined;

/**
 * @member {String} next
 */
PagedLinks.prototype['next'] = undefined;

/**
 * @member {String} last
 */
PagedLinks.prototype['last'] = undefined;
