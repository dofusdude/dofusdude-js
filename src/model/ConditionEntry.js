...
import ConditionEntryElement from './ConditionEntryElement';

/**
 * The ConditionEntry model module.
 * @module model/ConditionEntry
 * @version 0.8.0
 */
class ConditionEntry {
    /**
     * Constructs a new <code>ConditionEntry</code>.
     * @alias module:model/ConditionEntry
     */
    constructor() { 
        
        ConditionEntry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConditionEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConditionEntry} obj Optional instance to populate.
     * @return {module:model/ConditionEntry} The populated <code>ConditionEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConditionEntry();
            ...
            if (data.hasOwnProperty('element')) {
                obj['element'] = ConditionEntryElement.constructFromObject(data['element']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConditionEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConditionEntry</code>.
     */
    static validateJSON(data) {
        ...
        if (data['element']) { // data not null
          ConditionEntryElement.validateJSON(data['element']);
        }
 ...
 */
ConditionEntry.prototype['operator'] = undefined;

/**
 * @member {Number} int_value
 */
ConditionEntry.prototype['int_value'] = undefined;

/**
 * @member {module:model/ConditionEntryElement} element
 */
ConditionEntry.prototype['element'] = undefined;
