...
class AlmanaxEntryTribute {
    ...
    /**
     * Validates the JSON data with respect to <code>AlmanaxEntryTribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlmanaxEntryTribute</code>.
     */
    static validateJSON(data) {
        // validate the optional field `item`
        if (data['item']) { // data not null
          AlmanaxEntryTributeItem.validateJSON(data['item']);
        }
