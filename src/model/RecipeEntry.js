...
/**
 * The RecipeEntry model module.
 * @module model/RecipeEntry
 * @version 0.8.3
 */
class RecipeEntry {
    /**
     * Constructs a new <code>RecipeEntry</code>.
     * @alias module:model/RecipeEntry
     */
    constructor() { 
        
        RecipeEntry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RecipeEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecipeEntry} obj Optional instance to populate.
     * @return {module:model/RecipeEntry} The populated <code>RecipeEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecipeEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>RecipeEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecipeEntry</code>.
     */
 ...
 */
RecipeEntry.prototype['item_ankama_id'] = undefined;

/**
 * @member {String} item_subtype
 */
RecipeEntry.prototype['item_subtype'] = undefined;

/**
 * @member {Number} quantity
 */
RecipeEntry.prototype['quantity'] = undefined;
