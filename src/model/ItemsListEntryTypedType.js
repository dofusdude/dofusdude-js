...
/**
 * The ItemsListEntryTypedType model module.
 * @module model/ItemsListEntryTypedType
 * @version 0.8.0
 */
class ItemsListEntryTypedType {
    /**
     * Constructs a new <code>ItemsListEntryTypedType</code>.
     * @alias module:model/ItemsListEntryTypedType
     */
    constructor() { 
        
        ItemsListEntryTypedType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemsListEntryTypedType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemsListEntryTypedType} obj Optional instance to populate.
     * @return {module:model/ItemsListEntryTypedType} The populated <code>ItemsListEntryTypedType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemsListEntryTypedType();
    ...
    /**
     * Validates the JSON data with respect to <code>ItemsListEntryTypedType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemsListEntryTypedType</code>.
     */
 ...
 * @member {String} name
 */
ItemsListEntryTypedType.prototype['name'] = undefined;

/**
 * @member {Number} id
 */
ItemsListEntryTypedType.prototype['id'] = undefined;
...
export default ItemsListEntryTypedType;
