...
/**
 * The EffectsEntryType model module.
 * @module model/EffectsEntryType
 * @version 0.7.1
 */
class EffectsEntryType {
    /**
     * Constructs a new <code>EffectsEntryType</code>.
     * @alias module:model/EffectsEntryType
     */
    constructor() { 
        
        EffectsEntryType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EffectsEntryType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EffectsEntryType} obj Optional instance to populate.
     * @return {module:model/EffectsEntryType} The populated <code>EffectsEntryType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EffectsEntryType();
    ...
    /**
     * Validates the JSON data with respect to <code>EffectsEntryType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EffectsEntryType</code>.
     */
 ...
 * @member {String} name
 */
EffectsEntryType.prototype['name'] = undefined;

/**
 * @member {Number} id
 */
EffectsEntryType.prototype['id'] = undefined;
 ...
 */
EffectsEntryType.prototype['is_meta'] = undefined;

/**
 * Affects target or source actively.
 * @member {Boolean} is_active
 */
EffectsEntryType.prototype['is_active'] = undefined;
...
export default EffectsEntryType;
