...
/**
 * The EquipmentParentSet model module.
 * @module model/EquipmentParentSet
 * @version 0.7.2
 */
class EquipmentParentSet {
    /**
     * Constructs a new <code>EquipmentParentSet</code>.
     * @alias module:model/EquipmentParentSet
     */
    constructor() { 
        
        EquipmentParentSet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EquipmentParentSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EquipmentParentSet} obj Optional instance to populate.
     * @return {module:model/EquipmentParentSet} The populated <code>EquipmentParentSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EquipmentParentSet();
    ...
    /**
     * Validates the JSON data with respect to <code>EquipmentParentSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EquipmentParentSet</code>.
     */
 ...
 * @member {Number} id
 */
EquipmentParentSet.prototype['id'] = undefined;

/**
 * @member {String} name
 */
EquipmentParentSet.prototype['name'] = undefined;
...
export default EquipmentParentSet;
