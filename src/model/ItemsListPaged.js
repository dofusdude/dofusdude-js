...
/**
 * The ItemsListPaged model module.
 * @module model/ItemsListPaged
 * @version 0.7.1
 */
class ItemsListPaged {
    /**
     * Constructs a new <code>ItemsListPaged</code>.
     * @alias module:model/ItemsListPaged
     */
    constructor() { 
        
        ItemsListPaged.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemsListPaged</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemsListPaged} obj Optional instance to populate.
     * @return {module:model/ItemsListPaged} The populated <code>ItemsListPaged</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemsListPaged();

            if (data.hasOwnProperty('_links')) {
                obj['_links'] = LinksPaged.constructFromObject(data['_links']);
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ItemListEntry]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemsListPaged</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemsListPaged</code>.
     */
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ItemListEntry.validateJsonObject(item);
            };
        }
 ...
 */
ItemsListPaged.prototype['_links'] = undefined;

/**
 * @member {Array.<module:model/ItemListEntry>} items
 */
ItemsListPaged.prototype['items'] = undefined;
