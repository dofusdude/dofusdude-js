...
import SetEffectsEntry from './SetEffectsEntry';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('effects')) {
                obj['effects'] = ApiClient.convertToType(data['effects'], [[SetEffectsEntry]]);
            }
...
/**
 * @member {Array.<Array.<module:model/SetEffectsEntry>>} effects
 */
SetListEntry.prototype['effects'] = undefined;

/**
 * @member {Array.<Number>} equipment_ids
 */
SetListEntry.prototype['equipment_ids'] = undefined;

/**
 * @member {Boolean} is_cosmetic
 */
SetListEntry.prototype['is_cosmetic'] = undefined;
