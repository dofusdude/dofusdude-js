...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.GetMetaWebhooksTwitter200Response();
  });
  ...
  describe('GetMetaWebhooksTwitter200Response', function() {
    it('should create an instance of GetMetaWebhooksTwitter200Response', function() {
      // uncomment below and update the code to test GetMetaWebhooksTwitter200Response
      //var instance = new dofusdude.GetMetaWebhooksTwitter200Response();
      //expect(instance).to.be.a(dofusdude.GetMetaWebhooksTwitter200Response);
    });
