...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.PutAlmanaxWebhook();
  });
  ...
  describe('PutAlmanaxWebhook', function() {
    it('should create an instance of PutAlmanaxWebhook', function() {
      // uncomment below and update the code to test PutAlmanaxWebhook
      //var instance = new dofusdude.PutAlmanaxWebhook();
      //expect(instance).to.be.a(dofusdude.PutAlmanaxWebhook);
    });
