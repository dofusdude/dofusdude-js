...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.SetEffectsEntryType();
  });
  ...
  describe('SetEffectsEntryType', function() {
    it('should create an instance of SetEffectsEntryType', function() {
      // uncomment below and update the code to test SetEffectsEntryType
      //var instance = new dofusdude.SetEffectsEntryType();
      //expect(instance).to.be.a(dofusdude.SetEffectsEntryType);
    });
