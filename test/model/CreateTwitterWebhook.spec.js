...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.CreateTwitterWebhook();
  });
  ...
  describe('CreateTwitterWebhook', function() {
    it('should create an instance of CreateTwitterWebhook', function() {
      // uncomment below and update the code to test CreateTwitterWebhook
      //var instance = new dofusdude.CreateTwitterWebhook();
      //expect(instance).to.be.a(dofusdude.CreateTwitterWebhook);
    });
