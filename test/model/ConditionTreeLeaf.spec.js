...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.ConditionTreeLeaf();
  });
  ...
  describe('ConditionTreeLeaf', function() {
    it('should create an instance of ConditionTreeLeaf', function() {
      // uncomment below and update the code to test ConditionTreeLeaf
      //var instance = new dofusdude.ConditionTreeLeaf();
      //expect(instance).to.be.a(dofusdude.ConditionTreeLeaf);
    });
