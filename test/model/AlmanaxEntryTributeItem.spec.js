...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DofusdudeApi.AlmanaxEntryTributeItem();
  });
  ...
  describe('AlmanaxEntryTributeItem', function() {
    it('should create an instance of AlmanaxEntryTributeItem', function() {
      // uncomment below and update the code to test AlmanaxEntryTributeItem
      //var instance = new DofusdudeApi.AlmanaxEntryTributeItem();
      //expect(instance).to.be.a(DofusdudeApi.AlmanaxEntryTributeItem);
    });
