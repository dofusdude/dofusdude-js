...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.AlmanaxEntryTributeItem();
  });
  ...
  describe('AlmanaxEntryTributeItem', function() {
    it('should create an instance of AlmanaxEntryTributeItem', function() {
      ...
      //var instance = new dofusdude.AlmanaxEntryTributeItem();
      //expect(instance).to.be.a(dofusdude.AlmanaxEntryTributeItem);
    });
