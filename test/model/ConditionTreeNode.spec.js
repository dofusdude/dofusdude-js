...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.ConditionTreeNode();
  });
  ...
  describe('ConditionTreeNode', function() {
    it('should create an instance of ConditionTreeNode', function() {
      // uncomment below and update the code to test ConditionTreeNode
      //var instance = new dofusdude.ConditionTreeNode();
      //expect(instance).to.be.a(dofusdude.ConditionTreeNode);
    });
