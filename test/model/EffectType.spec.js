...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.EffectType();
  });
  ...
  describe('EffectType', function() {
    it('should create an instance of EffectType', function() {
      // uncomment below and update the code to test EffectType
      //var instance = new dofusdude.EffectType();
      //expect(instance).to.be.a(dofusdude.EffectType);
    });
