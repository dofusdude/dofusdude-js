...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DofusdudeApi.Cosmetic();
  });
  ...
  describe('Cosmetic', function() {
    it('should create an instance of Cosmetic', function() {
      // uncomment below and update the code to test Cosmetic
      //var instance = new DofusdudeApi.Cosmetic();
      //expect(instance).to.be.a(DofusdudeApi.Cosmetic);
    });
