...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.ListItemGeneral();
  });
  ...
  describe('ListItemGeneral', function() {
    it('should create an instance of ListItemGeneral', function() {
      // uncomment below and update the code to test ListItemGeneral
      //var instance = new dofusdude.ListItemGeneral();
      //expect(instance).to.be.a(dofusdude.ListItemGeneral);
    });
