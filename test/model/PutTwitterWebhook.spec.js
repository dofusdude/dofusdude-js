...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.PutTwitterWebhook();
  });
  ...
  describe('PutTwitterWebhook', function() {
    it('should create an instance of PutTwitterWebhook', function() {
      // uncomment below and update the code to test PutTwitterWebhook
      //var instance = new dofusdude.PutTwitterWebhook();
      //expect(instance).to.be.a(dofusdude.PutTwitterWebhook);
    });
