...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.PagedLinks();
  });
  ...
  describe('PagedLinks', function() {
    it('should create an instance of PagedLinks', function() {
      // uncomment below and update the code to test PagedLinks
      //var instance = new dofusdude.PagedLinks();
      //expect(instance).to.be.a(dofusdude.PagedLinks);
    });
