...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.ConditionNode();
  });
  ...
  describe('ConditionNode', function() {
    it('should create an instance of ConditionNode', function() {
      // uncomment below and update the code to test ConditionNode
      //var instance = new dofusdude.ConditionNode();
      //expect(instance).to.be.a(dofusdude.ConditionNode);
    });
