...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.CreateRSSWebhook();
  });
  ...
  describe('CreateRSSWebhook', function() {
    it('should create an instance of CreateRSSWebhook', function() {
      // uncomment below and update the code to test CreateRSSWebhook
      //var instance = new dofusdude.CreateRSSWebhook();
      //expect(instance).to.be.a(dofusdude.CreateRSSWebhook);
    });
