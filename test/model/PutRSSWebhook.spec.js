...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.PutRSSWebhook();
  });
  ...
  describe('PutRSSWebhook', function() {
    it('should create an instance of PutRSSWebhook', function() {
      // uncomment below and update the code to test PutRSSWebhook
      //var instance = new dofusdude.PutRSSWebhook();
      //expect(instance).to.be.a(dofusdude.PutRSSWebhook);
    });
