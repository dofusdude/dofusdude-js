...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.AlmanaxTributeItem();
  });
  ...
  describe('AlmanaxTributeItem', function() {
    it('should create an instance of AlmanaxTributeItem', function() {
      // uncomment below and update the code to test AlmanaxTributeItem
      //var instance = new dofusdude.AlmanaxTributeItem();
      //expect(instance).to.be.a(dofusdude.AlmanaxTributeItem);
    });
