...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.ConditionLeaf();
  });
  ...
  describe('ConditionLeaf', function() {
    it('should create an instance of ConditionLeaf', function() {
      // uncomment below and update the code to test ConditionLeaf
      //var instance = new dofusdude.ConditionLeaf();
      //expect(instance).to.be.a(dofusdude.ConditionLeaf);
    });
