...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.ConditionRelation();
  });
  ...
  describe('ConditionRelation', function() {
    it('should create an instance of ConditionRelation', function() {
      // uncomment below and update the code to test ConditionRelation
      //var instance = new dofusdude.ConditionRelation();
      //expect(instance).to.be.a(dofusdude.ConditionRelation);
    });
