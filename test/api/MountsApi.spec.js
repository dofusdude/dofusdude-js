...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dofusdude.MountsApi();
  });
  ...
  describe('MountsApi', function() {
    describe('getAllMountsList', function() {
      it('should call getAllMountsList successfully', function(done) {
        //uncomment below and update the code to test getAllMountsList
        //instance.getAllMountsList(function(error) {
    ...
    describe('getMountsList', function() {
      it('should call getMountsList successfully', function(done) {
        //uncomment below and update the code to test getMountsList
        //instance.getMountsList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMountsSearch', function() {
      it('should call getMountsSearch successfully', function(done) {
        //uncomment below and update the code to test getMountsSearch
        //instance.getMountsSearch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMountsSingle', function() {
      it('should call getMountsSingle successfully', function(done) {
        //uncomment below and update the code to test getMountsSingle
        //instance.getMountsSingle(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
