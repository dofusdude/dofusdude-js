...
(function(root, factory) {
  ...
  describe('SetsApi', function() {
    describe('getAllSetsList', function() {
      it('should call getAllSetsList successfully', function(done) {
        //uncomment below and update the code to test getAllSetsList
        //instance.getAllSetsList(function(error) {
